<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WFrm_NotasGestion.aspx.cs" Inherits="SoftCob.Views.Gestion.WFrm_NotasGestion" %>
                    ...
                    <ContentTemplate>
                        <table style="width: 100%">
                            <tr>
                                ...
                                <td style="width: 25%">
                                    <h5>Fecha Recordatorio:</h5>
                                </td>
                                <td style="width: 55%">
                                    <asp:TextBox ID="TxtFechaRecordatorio" runat="server" Width="100%" CssClass="form-control" TabIndex="1"></asp:TextBox>
                                </td>
                                <td style="width: 10%"></td>
                            </tr>
                            <tr>
                                <td></td>
                                <td>
                                    <h5>Tipo Recordatorio:</h5>
                                </td>
                                <td>
                                    <asp:DropDownList ID="DdlMantener" runat="server" CssClass="form-control" TabIndex="2" Width="100%">
                                    </asp:DropDownList>
                                </td>
                                <td>
                            </tr>
