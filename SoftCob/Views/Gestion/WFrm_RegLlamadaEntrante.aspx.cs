    ...
    public partial class WFrm_RegLlamadaEntrante : Page
    {
        ...
        protected void ImgArbol_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                {
                    new FuncionesDAO().FunShowJSMessage("Ingrese Cedula a Consultar..", this, "W", "C");
                    return;
                }

                if (TxtCedula.Text.Trim().Length < 10)
                {
                    new FuncionesDAO().FunShowJSMessage("Dato tiene menos de 10 digitos..", this, "E", "C");
                    return;
                }
        ...
        protected void BtnGrabar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (ViewState["Llamar"].ToString() == "S")
                {
                    ...
                    {
                        new FuncionesDAO().FunShowJSMessage("Ingrese Hora de llamada/ sumando 10 minutos a la hora actual..!", this, "W", "C");
                        return;
                    }
                ...
                {
                    new FuncionesDAO().FunShowJSMessage("Seleccione número de teléfono o ingrese nuevo..!", this, "W", "C");
                    return;
                }
        ...
        protected void ImgAddTelefono_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                if (FunValidarTelefonos())
                {
                    ...
                    if (_mensaje != "")
                    {
                        new FuncionesDAO().FunShowJSMessage("El Teléfono se encuenta INACTIVO, solcite ACTIVAR el mismo..!", this, "E", "C");
                        return;
                    }
        ...
        protected void Imgupdate_Click(object sender, ImageClickEventArgs e)
        {
            ScriptManager.RegisterStartupScript(this.updCabecera, GetType(), "Visualizar", "javascript: var posicion_x; var posicion_y; posicion_x=(screen.width/2)-(900/2); " +
                ...
                ViewState["CodigoPERS"].ToString() + "&NumDocumento=" + ViewState["NumeroDocumento"].ToString() + "',null,'left=' + " +
