<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WFrm_ListaVolveraLlamar.aspx.cs" Inherits="SoftCob.Views.Gestion.WFrm_ListaVolveraLlamar" %>
                            ...
                            <tr>
                                <td>
                                    <asp:GridView ID="GrdvDatos" runat="server" Width="100%" AutoGenerateColumns="False"
                                        ...
                                        ShowHeaderWhenEmpty="True" DataKeyNames="codigoCEDE,codigoCPCE,codigoCLDE,codigoPERS,Identificacion,Operacion,FechaLlamar,HoraLlamar" OnRowDataBound="GrdvDatos_RowDataBound">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="FechaLlamar" HeaderText="Fecha_Llamar">
                                            <ItemStyle HorizontalAlign="Center" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="HoraLlamar" HeaderText="Hora">
                                            <ItemStyle HorizontalAlign="Center" />
                                            </asp:BoundField>
