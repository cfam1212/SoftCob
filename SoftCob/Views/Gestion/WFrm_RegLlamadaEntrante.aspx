                                ...
                                <td colspan="6">
                                    ...
                                    <div class="panel panel-primary" runat="server" id="DivBotones">
                                        <table style="width: 100%">
                                            ...
                                            <tr>
                                                <td colspan="5">
                                                    <asp:Panel ID="PnlBotones" runat="server" Height="120px" GroupingText="Opción Botones">
                                                        <table style="width: 100%">
                                                            <tr>
                                                                <td style="width: 15%"></td>
                                                                <td style="width: 10%"></td>
                                        ...
                                        <asp:Panel ID="PnlOpcionLlamar" runat="server" Height="100px" GroupingText="Registro Volver a Llamar" TabIndex="33">
                                            <table style="width: 100%">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="TxtFechaLLamar" runat="server" TabIndex="34" Width="100%"></asp:TextBox>
                                                    </td>
                                                    <td>
                                                        <h5>Hora Llamar:</h5>
                                                    </td>
