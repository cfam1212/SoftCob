...
namespace SoftCob.Views.ListaTrabajo
{
    ...
    public partial class WFrm_ListaTrabajoAdminEFE : Page
    {
        #region Variables
        ...
        protected void FunCargarMantenimiento()
        {
            try
            {
                _dts = new ConsultaDatosDAO().FunConsultaDatos(24, 3, 0, 0, "", "", "", ViewState["Conectar"].ToString());
        ...
        {
            Response.Redirect("WFrm_NuevaListaTrabajoEFE.aspx?CodigoLista=0" + "&Regresar=L", true);
        }
        ...
        protected void Btnselecc_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.Redirect("WFrm_NuevaListaTrabajoEFE.aspx?CodigoLista=" + _codigo + "&Regresar=L", true);
        }
        #endregion
    }
}