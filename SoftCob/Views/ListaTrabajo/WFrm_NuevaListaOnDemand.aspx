<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WFrm_NuevaListaOnDemand.aspx.cs" Inherits="SoftCob.Views.ListaTrabajo.WFrm_NuevaListaOnDemand" %>
        ...
        <div class="panel panel-primary">
                    ...
                    <ContentTemplate>
                        <table style="width: 100%">
                                    ...
                                    <asp:Panel ID="pnlDatosListas" runat="server" Height="250px" GroupingText="Datos Lista" TabIndex="7">
                                        <table style="width: 100%">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="TxtLista" runat="server" CssClass="form-control upperCase" MaxLength="150" TabIndex="3" Width="100%">LST_OND.</asp:TextBox>
                                                </td>
                                                <td>
                                                    <h5>Descripción:</h5>
                                                </td>
                            ...
                            <tr>
                                <td></td>
                                <td colspan="4">
                                    <asp:Panel ID="pnlConfigurar" runat="server" Height="130px" GroupingText="Configurar Opciones">
                                        <table style="width: 100%">
                                            <tr>
                                                <td style="width: 15%"></td>
                                                <td style="width: 35%"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:DropDownList ID="DdlGestorApoyo" runat="server" AutoPostBack="True" CssClass="form-control" TabIndex="13" Width="100%">
                                                    </asp:DropDownList>
                                                </td>
                                            </tr>
                                        </table>
            ...
            <div class="panel panel-default">
                <asp:UpdatePanel ID="updBotones" runat="server">
                        ...
                        <table style="width: 100%">
                            ...
                            <tr>
                                ...
                                <td style="text-align: center;">
                                    <asp:ImageButton ID="ImgPreview" runat="server" Height="25px" ImageUrl="~/Botones/Buscar.png" OnClick="ImgPreview_Click" TabIndex="16" />
                                </td>
                                <td>
                                    ...
                                    <asp:Panel ID="pnlPreview" runat="server" Height="380px" ScrollBars="Vertical">
                                        <asp:GridView ID="GrdvPreview" runat="server" AutoGenerateColumns="False"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="FechaGestion" HeaderText="Ult. Fecha Gestión">
                    ...
                    <Triggers>
                        <asp:PostBackTrigger ControlID="ImgPreview" />
                    </Triggers>
                </asp:UpdatePanel>
            </div>
        </div>
