                                    ...
                                    <asp:Panel ID="pnlDatosListas" runat="server" Height="250px" GroupingText="Datos Lista" TabIndex="3">
                                        <table style="width: 100%">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="TxtLista" runat="server" CssClass="form-control upperCase" MaxLength="150" TabIndex="4" Width="100%">LST_EXT.</asp:TextBox>
                                                </td>
                                                <td>
                                                    <h5>Descripción:</h5>
                                                </td>
                                ...
                                <td colspan="4">
                                    <asp:Panel ID="pnlOpcionGestion" runat="server" GroupingText="Opción Gestiones" TabIndex="20">
                                        <table style="width: 100%">
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:CheckBox ID="ChkGestion" runat="server" AutoPostBack="True" CssClass="form-control" OnCheckedChanged="ChkGestion_CheckedChanged" TabIndex="18" Text="Gestión" />
                                                </td>
                                                <td>
