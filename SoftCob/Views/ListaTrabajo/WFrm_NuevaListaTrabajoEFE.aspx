<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WFrm_NuevaListaTrabajoEFE.aspx.cs" Inherits="SoftCob.Views.ListaTrabajo.WFrm_NuevaListaTrabajoEFE" %>
                    ...
                    <ContentTemplate>
                        <table style="width: 100%">
                                    ...
                                    <asp:Panel ID="PnlDatosListas" runat="server" Height="250px" GroupingText="Datos Lista" TabIndex="3">
                                        <table style="width: 100%">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="TxtLista" runat="server" CssClass="form-control upperCase" MaxLength="150" TabIndex="4" Width="100%">LST_EFE.</asp:TextBox>
                                                </td>
                                                <td>
                                                    <h5>Descripción:</h5>
                                                </td>
                                    ...
                                    <asp:Panel ID="PnlConfiguracion" runat="server" GroupingText="Configurar Opciones" TabIndex="14" Height="80px">
                                        <table style="width: 100%">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:DropDownList ID="DdlCampania" runat="server" AutoPostBack="True" CssClass="form-control" TabIndex="16" Width="100%" OnSelectedIndexChanged="DdlCampania_SelectedIndexChanged">
                                                    </asp:DropDownList>
                                                </td>
                                                <td>
                                                    <h5>Asignación:</h5>
                                                ...
                                                <td>
                                                    <asp:DropDownList ID="DdlAsignacion" runat="server" AutoPostBack="True" CssClass="form-control" TabIndex="15" Width="100%" OnSelectedIndexChanged="DdlAsignacion_SelectedIndexChanged">
                                                    </asp:DropDownList>
                                                </td>
                                            </tr>
                                        </table>
                            ...
                            <tr>
                                <td></td>
                                <td colspan="4">
                                    <asp:Panel ID="PnlEfecto" runat="server" GroupingText="Configurar Árbol Efecto" TabIndex="14" Height="320px" Visible="False">
                                        <table style="width: 100%">
                                            <tr>
                                                <td style="width: 10%"></td>
                                                <td style="width: 35%"></td>
                                            ...
                                            <tr>
                                                <td colspan="2">
                                                    <asp:Panel ID="PnlEfectos" runat="server" GroupingText="Efectos" Height="230px" ScrollBars="Vertical">
                                                        <asp:GridView ID="GrdvEfecto" runat="server" AutoGenerateColumns="False" CssClass="table table-condensed table-bordered table-hover table-responsive" DataKeyNames="Codigo" ShowHeaderWhenEmpty="True" TabIndex="10" Width="100%" OnRowDataBound="GrdvEfecto_RowDataBound">
                                                            <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                                                            <Columns>
                                ...
                                <td colspan="4">
                                    <asp:Panel ID="PnlOpcionGestion" runat="server" GroupingText="Opción Gestiones" TabIndex="20">
                                        <table style="width: 100%">
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:CheckBox ID="ChkGestor" runat="server" CssClass="form-control" AutoPostBack="True" OnCheckedChanged="ChkGestor_CheckedChanged" TabIndex="18" Text="Gestor" />
                                                </td>
                                                <td>
                                                    <asp:DropDownList ID="DdlGestor" runat="server" AutoPostBack="True" CssClass="form-control" Enabled="False" TabIndex="19" Width="100%">
                                                    </asp:DropDownList>
                                                </td>
                                                <td>
                                                    <h5>Gestor Apoyo:</h5>
                                                ...
                                                <td>
                                                    <asp:DropDownList ID="DdlGestorApoyo" runat="server" CssClass="form-control" TabIndex="14" Width="100%">
                                                    </asp:DropDownList>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <asp:CheckBox ID="ChkFecha" runat="server" CssClass="form-control" AutoPostBack="True" OnCheckedChanged="ChkFecha_CheckedChanged" TabIndex="22" Text="Por Fecha" Checked="True" Enabled="False" />
                                                </td>
                                                <td>
