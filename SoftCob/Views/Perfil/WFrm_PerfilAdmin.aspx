<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WFrm_PerfilAdmin.aspx.cs" Inherits="SoftCob.Views.Perfil.WFrm_PerfilAdmin" %>
                                    ...
                                    <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            <asp:GridView ID="GrdvDatos" runat="server" Width="100%" AutoGenerateColumns="False"
                                                ...
                                                ShowHeaderWhenEmpty="True" EmptyDataText="No existen perfiles creados">
