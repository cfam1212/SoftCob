<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WFrm_ReportePagosCarteraFixed.aspx.cs" Inherits="SoftCob.Views.ReportesManager.WFrm_ReportePagosCarteraFixed" %>
                            ...
                            <table style="width: 100%">
                                ...
                                <tr>
                                    <td style="text-align: left">
                                        <asp:ImageButton ID="ImgExportar" runat="server" ImageUrl="~/Botones/excelbg.png" Width="40px" Height="30px" Visible="false" TabIndex="1" OnClick="ImgExportar_Click" />
                            ...
                            <asp:Panel ID="pnlGestiones" runat="server" Width="100%" Height="500px" ScrollBars="Auto">
                                <asp:GridView ID="GrdvDatos" runat="server" Width="100%"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="FechaPago" HeaderText="Fecha_Pago" DataFormatString="{0:d}">
                                            <ItemStyle HorizontalAlign="Right" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="ValorPago" HeaderText="Valor_Pago">
                                            <ItemStyle HorizontalAlign="Right" />
                                        </asp:BoundField>
