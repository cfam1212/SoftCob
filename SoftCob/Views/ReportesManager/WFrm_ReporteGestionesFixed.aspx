                            ...
                            <table style="width: 100%">
                                <tr>
                                    <td style="text-align: left">
                                        <asp:ImageButton ID="ImgExportar" runat="server" ImageUrl="~/Botones/excelbg.png" Width="40px" Height="30px" Visible="false" TabIndex="9" OnClick="ImgExportar_Click" />
                            ...
                            <asp:Panel ID="pnlGestiones" runat="server" Width="100%" Height="450px" ScrollBars="Auto">
                                <asp:GridView ID="GrdvDatos" runat="server" Width="100%"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="Sucursal" HeaderText="Provincia">
                                            <ItemStyle Wrap="False" />
                                        </asp:BoundField>
