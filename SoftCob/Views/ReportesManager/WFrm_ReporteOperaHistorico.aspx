<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WFrm_ReporteOperaHistorico.aspx.cs" Inherits="SoftCob.Views.ReportesManager.WFrm_ReporteOperaHistorico" %>
                            ...
                            <tr>
                                <td>
                                    <asp:GridView ID="GrdvDatos" runat="server" Width="100%"
                                        ...
                                        ShowHeaderWhenEmpty="True" EmptyDataText="No existen datos para mostrar" PageSize="20" AllowPaging="True" OnPageIndexChanging="grdvDatos_PageIndexChanging">
