            ...
            <div class="panel-body">
                <asp:UpdatePanel ID="updCabecera" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <table style="width: 100%">
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    ...
                                    <asp:DropDownList ID="DdlGestores" runat="server" AutoPostBack="True" CssClass="form-control" TabIndex="5" Width="100%">
                                    </asp:DropDownList>
                        ...
                        <div class="panel panel-default">
                            <table style="width: 100%">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h5 runat="server" id="LblExportar">Exportar</h5>
                                    </td>
                                    <td></td>
                                    <td></td>
                                    <td></td>
                        ...
                        <div class="panel-info">
                            <asp:Panel ID="pnlCallAnswerd" runat="server" ScrollBars="Vertical" Height="200px" GroupingText="Llamadas Efectivas">
