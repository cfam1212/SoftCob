<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WFrm_ReporteGestorCedente.aspx.cs" Inherits="SoftCob.Views.ReportesManager.WFrm_ReporteGestorCedente" %>
                            ...
                            <tr>
                                <td>
                                    <asp:GridView ID="GrdvDatos" runat="server" Width="100%"
                                        AutoGenerateColumns="False" DataKeyNames="codigoUSU"
