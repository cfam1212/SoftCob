<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WFrm_DepartamentoNuevo.aspx.cs" Inherits="SoftCob.Views.Configuraciones.WFrm_DepartamentoNuevo" %>
                        ...
                        <table style="width: 100%">
                            <tr>
                                <td style="text-align: right; width: 45%">
                                    <asp:Button ID="BtnGrabar" runat="server" Text="Grabar" Width="120px" CssClass="button" OnClick="BtnGrabar_Click" TabIndex="3" />
                                </td>
