    ...
    public partial class WFrm_NuevaBitacora : Page
    {
        ...
        protected void ImgAddAT_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                {
                    new FuncionesDAO().FunShowJSMessage("Hora ingresada incorrecta..!", this,"E","C");
                    return;
                }
                ...
                if (_existe)
                {
                    new FuncionesDAO().FunShowJSMessage("Gestor ya esta ingresado..!", this, "E", "C");
                    return;
                }
        ...
        protected void ImgAddPE_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                if (_existe)
                {
                    new FuncionesDAO().FunShowJSMessage("Gestor ya eata ingresado..!", this, "E", "C");
                    return;
                }
