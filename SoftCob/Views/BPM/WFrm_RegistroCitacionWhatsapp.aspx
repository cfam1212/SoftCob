<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WFrm_RegistroCitacionWhatsapp.aspx.cs" Inherits="SoftCob.Views.BPM.WFrm_RegistroCitacionWhatsapp" %>
                    ...
                    <ContentTemplate>
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <asp:Panel ID="PnlDatosGetion" runat="server" CssClass="panel panel-primary" Height="200px"
                                        ...
                                        <asp:GridView ID="GrdvDatosObligacion" runat="server" AutoGenerateColumns="False" CssClass="table table-condensed table-bordered table-hover table-responsive" DataKeyNames="Operacion,DiasMora" ForeColor="#333333" OnRowDataBound="GrdvDatosObligacion_RowDataBound" PageSize="5" ShowFooter="True" TabIndex="2" Width="100%">
                                            <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                                            <Columns>
                        ...
                        <table style="width: 100%">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:ImageButton ID="ImgCitacion" runat="server" Height="25px" ImageUrl="~/Botones/Buscar.png" OnClick="ImgCitacion_Click" />
                                </td>
                                <td></td>
                                <td></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <asp:Panel ID="PnlCitaciones" runat="server" CssClass="panel panel-primary"
                                        GroupingText="Proceso Envío Whastapp Citacion" Height="350px" ScrollBars="Vertical"
                                        TabIndex="17">
                                        <asp:GridView ID="GrdvCitaciones" runat="server" AutoGenerateColumns="False"
                                            CssClass="table table-condensed table-bordered table-hover table-responsive" ForeColor="#333333"
                                            Height="25px" OnRowDataBound="GrdvCitaciones_RowDataBound" PageSize="5" TabIndex="7" Width="100%" DataKeyNames="Enviado,Celular,Respuesta,CodigoHCIT">
                                            <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                                            <Columns>
