<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WFrm_CitacionProcesoTerreno.aspx.cs" Inherits="SoftCob.Views.BPM.WFrm_CitacionProcesoTerreno" %>
                                ...
                                <td>
                                    <asp:GridView ID="GrdvDatos" runat="server" Width="100%" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="TotalTerreno" HeaderText="Total Direccion">
                                                <ItemStyle HorizontalAlign="Right" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="ConRespuesta" HeaderText="Registrados">
                                                <ItemStyle HorizontalAlign="Right" />
                                            </asp:BoundField>
                                            <asp:BoundField DataField="Gestor" HeaderText="Gestor" />
                                            <asp:TemplateField HeaderText="Procesar">
                                                <ItemTemplate>
                                                    <asp:ImageButton ID="ImgCitacion" runat="server" Height="20px" ImageUrl="~/Botones/casa.png" OnClick="ImgCitacion_Click" />
                                                </ItemTemplate>
