                                    ...
                                    <td style="width: 80%">
                                        <table style="width: 100%">
                                                                ...
                                                                <asp:GridView ID="GrdvAccion" runat="server" AutoGenerateColumns="False" CssClass="table table-condensed table-bordered table-hover table-responsive" DataKeyNames="Codigo,Estado,Contacto" ForeColor="#333333" PageSize="5" TabIndex="5" Width="100%" OnRowDataBound="GrdvAccion_RowDataBound" OnSelectedIndexChanged="GrdvAccion_SelectedIndexChanged">
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Selecc">
                                                                            <ItemTemplate>
                                                                                <asp:ImageButton ID="ImgSelecAccion" runat="server" Height="20px" ImageUrl="~/Botones/selecc.png" OnClick="ImgSelecAccion_Click" />
                                                                            </ItemTemplate>
                                                                            <ItemStyle HorizontalAlign="Center" />
                                                                        </asp:TemplateField>
                                                                        <asp:TemplateField HeaderText="Eliminar">
                                                                            <ItemTemplate>
                                                                                <asp:ImageButton ID="ImgDelAccion" runat="server" Height="20px" ImageUrl="~/Botones/eliminar.png" OnClick="ImgDelAccion_Click" />
                                                                            </ItemTemplate>
                                                                            <ItemStyle HorizontalAlign="Center" />
                                                                        </asp:TemplateField>
                                                                    </Columns>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center">
                                                    <asp:ImageButton ID="ImgModiEfecto" runat="server" Height="20px" ImageUrl="~/Botones/modificar.png" OnClick="ImgModiEfecto_Click" TabIndex="8" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                            ...
                                                            <asp:Panel ID="pnlEfecto" runat="server" Height="180px" ScrollBars="Vertical" Visible="false">
                                                                <asp:GridView ID="GrdvEfecto" runat="server" AutoGenerateColumns="False"
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Editar">
                                                                            <ItemTemplate>
                                                                                <asp:ImageButton ID="ImgEdiEfecto" runat="server" Height="15px" ImageUrl="~/Botones/seleccionar.png" OnClick="ImgEdiEfecto_Click" />
                                                                            </ItemTemplate>
                                                                            <ItemStyle HorizontalAlign="Center" />
                                                                        </asp:TemplateField>
                                                                        <asp:TemplateField HeaderText="Selecc">
                                                                            <ItemTemplate>
                                                                                <asp:ImageButton ID="ImgSelecEfecto" runat="server" Height="15px" ImageUrl="~/Botones/selecc.png" OnClick="ImgSelecEfecto_Click" />
                                                                            </ItemTemplate>
                                                                            <ItemStyle HorizontalAlign="Center" />
                                                                        </asp:TemplateField>
                                                                        <asp:TemplateField HeaderText="Eliminar">
                                                                            <ItemTemplate>
                                                                                <asp:ImageButton ID="ImgDelEfecto" runat="server" Height="15px" ImageUrl="~/Botones/eliminar.png" OnClick="ImgDelEfecto_Click" />
                                                                            </ItemTemplate>
                                                                            <ItemStyle HorizontalAlign="Center" />
                                                                        </asp:TemplateField>
                                                                    </Columns>
                                                            ...
                                                            <asp:Panel ID="pnlRespuesta" runat="server" Height="180px" ScrollBars="Vertical" Visible="false">
                                                                <asp:GridView ID="GrdvRespuesta" runat="server" AutoGenerateColumns="False" CssClass="table table-condensed table-bordered table-hover table-responsive" DataKeyNames="Codigo,CodigoEfecto" ForeColor="#333333" PageSize="5" TabIndex="14" Width="100%" OnRowDataBound="GrdvRespuesta_RowDataBound">
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Editar">
                                                                            <ItemTemplate>
                                                                                <asp:ImageButton ID="ImgEdiRespuesta" runat="server" Height="15px" ImageUrl="~/Botones/seleccionar.png" OnClick="ImgEdiRespuesta_Click" />
                                                                            </ItemTemplate>
                                                                            <ItemStyle HorizontalAlign="Center" />
                                                                        </asp:TemplateField>
                                                                        <asp:TemplateField HeaderText="Selecc">
                                                                            <ItemTemplate>
                                                                                <asp:ImageButton ID="ImgSelecRespuesta" runat="server" Height="15px" ImageUrl="~/Botones/selecc.png" OnClick="ImgSelecRespuesta_Click" />
                                                                            </ItemTemplate>
                                                                            <ItemStyle HorizontalAlign="Center" />
                                                                        </asp:TemplateField>
                                                                        <asp:TemplateField HeaderText="Eliminar">
                                                                            <ItemTemplate>
                                                                                <asp:ImageButton ID="ImgDelRespuesta" runat="server" Height="15px" ImageUrl="~/Botones/eliminar.png" OnClick="ImgDelRespuesta_Click" />
                                                                            </ItemTemplate>
                                                                            <ItemStyle HorizontalAlign="Center" />
                                                                        </asp:TemplateField>
                                                                    </Columns>
                                                            ...
                                                            <asp:Panel ID="pnlContacto" runat="server" Height="180px" ScrollBars="Vertical" Visible="false">
                                                                <asp:GridView ID="GrdvContacto" runat="server" AutoGenerateColumns="False" CssClass="table table-condensed table-bordered table-hover table-responsive" DataKeyNames="Codigo,CodigoRespuesta" ForeColor="#333333" PageSize="5" TabIndex="18" Width="100%" OnRowDataBound="GrdvContacto_RowDataBound">
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Editar">
                                                                            <ItemTemplate>
                                                                                <asp:ImageButton ID="ImgEdiContacto" runat="server" Height="15px" ImageUrl="~/Botones/seleccionar.png" OnClick="ImgEdiContacto_Click" />
                                                                            </ItemTemplate>
                                                                            <ItemStyle HorizontalAlign="Center" />
                                                                        </asp:TemplateField>
                                                                        <asp:TemplateField HeaderText="Eliminar">
                                                                            <ItemTemplate>
                                                                                <asp:ImageButton ID="ImgDelContacto" runat="server" Height="15px" ImageUrl="~/Botones/eliminar.png" OnClick="ImgDelContacto_Click" />
                                                                            </ItemTemplate>
                                                                            <ItemStyle HorizontalAlign="Center" />
                                                                        </asp:TemplateField>
                                                                    </Columns>
