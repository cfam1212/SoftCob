    ...
    public partial class WFrm_CrearCitacion : Page
    {
        ...
        private void FunCargarCombos(int opcion)
        {
            switch (opcion)
            {
                case 0:
                    ...
                    DdlDireccion.DataSource = new CatalogosDTO().FunGetParametroDetalleValor("TIPO CLIENTE",
                        "--Seleccione Tipo Direccion--");
                    DdlDireccion.DataTextField = "Descripcion";
                    DdlDireccion.DataValueField = "Codigo";
                    DdlDireccion.DataBind();

                    DdlTipoMail.DataSource = new CatalogosDTO().FunGetParametroDetalleValor("TIPO CLIENTE",
                        "--Seleccione Tipo Correo--");
        ...
        protected void ImgAgregarMail_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                {
                    new FuncionesBAS().FunShowJSMessage("Seleccione Tipo Mail..!", this);
                    return;
                }

                if (string.IsNullOrEmpty(TxtEmail.Text.Trim()))
                {
                    new FuncionesBAS().FunShowJSMessage("Ingrese Email..!", this);
                    return;
                }

                if (!new FuncionesBAS().Email_bien_escrito(TxtEmail.Text.Trim()))
                {
                    new FuncionesBAS().FunShowJSMessage("Email Incorrecto..!", this);
                    return;
                }
                ...
                if (_lexiste)
                {
                    new FuncionesBAS().FunShowJSMessage("Ya Existe Email Agregado..!", this);
                    return;
                }
        ...
        protected void ImgAgregarTerreno_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                {
                    new FuncionesBAS().FunShowJSMessage("Seleccione Tipo Direccion..!", this);
                    return;
                }

                if (string.IsNullOrEmpty(TxtDireccion.Text.Trim()))
                {
                    new FuncionesBAS().FunShowJSMessage("Ingrese Direccion..!", this);
                    return;
                }
        ...
        protected void BtnGrabar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    new FuncionesBAS().FunShowJSMessage("Ingrese Valor Citacion..!", this);
                    return;
                }

                if (!ChkWathaspp.Checked && !ChkEmail.Checked && !ChkTerreno.Checked)
                {
                    new FuncionesBAS().FunShowJSMessage("Seleccione Tipo de Envio Citacion..!", this);
                    return;
                }
                ...
                if (ChkWathaspp.Checked)
                {
                    ...
                    if (_result.Count() == 0)
                    {
                        new FuncionesBAS().FunShowJSMessage("Seleccione al menos un numero de Celular...!", this);
                        return;
                    }
                ...
                if (ChkEmail.Checked)
                {
                    ...
                    if (_result.Count() == 0)
                    {
                        new FuncionesBAS().FunShowJSMessage("Seleccione al menos un Mail...!", this);
                        return;
                    }
                ...
                if (ChkTerreno.Checked)
                {
                    ...
                    if (_result.Count() == 0)
                    {
                        new FuncionesBAS().FunShowJSMessage("Seleccione al menos una Direccion...!", this);
                        return;
                    }
